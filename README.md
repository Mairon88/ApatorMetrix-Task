...
## (link do opisu projektu, z którego można przejśc do raportu w postaci html -> https://mairon88.github.io/ApatorMetrix-Task/)
...
Przykładowy raport wygenerowany przez pytest-html znajduje się tutaj: [Link do raportu](raport.html)
